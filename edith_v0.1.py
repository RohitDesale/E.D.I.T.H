    ...
    while True:
        ...
        # Converses, barely.**************-------------************-------------------*************---------------*****
            ...
            speak("I am Edith. EDITH is the abbreviation of EVEN DEATH I AM HERO. I am the "
                  "clone of original edith created by Mister Rohit Desale.")
        ...
        # plays music *************---------------******************-----------------**********--------*************
            ...
            music_folder = "D:\Music\bluetooth"
        ...
        # Sends email **************************-------------------***************---------------**************
            ...
            if 'I am' in sender:
                try:
                    ...
                    t.sleep(2)
                    speak(content)
                    server = rohitdesale29122002lib.rohitdesale29122002('rohitdesale29122002@gmail.com',)
                    server.ehlo()
                    server.starttls()
                    server.login("rohitdesale29122002@gmail.com", '')
                    server.sendmail('rohitdesale29122002@gmail.com', Recipient_user, content)
                    server.close()
                    speak('Email sent!')
